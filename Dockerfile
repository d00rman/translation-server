...
RUN mkdir -p /opt/translation-server
...
RUN bash fetch_sdk \
	...
	&& git clone https://github.com/wikimedia/mediawiki-services-zotero-translators /opt/translation-server/modules/zotero/translators
